---
title: envshare.dev
description: EnvShare is a simple way to share environment variables securely. It encrypts your data in the browser before sending it to the server, and the decryption key is included in the URL fragment - which is never sent to the server.
date: "2023-01-15"
...
EnvShare is a tool for securely sharing environment variables. It encrypts your data in the browser before sending it to the server, and the decryption key is included in the URL fragment.
