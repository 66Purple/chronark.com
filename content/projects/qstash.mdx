---
title: QStash
description: QStash is a fully managed message queue and task scheduler designed for serverless and edge runtimes. It's built for modern web architectures and provides a simple, yet powerful API.
date: "2023-02-15"
...
QStash is a HTTP based messaging and scheduling solution for the serverless and edge runtime world.
